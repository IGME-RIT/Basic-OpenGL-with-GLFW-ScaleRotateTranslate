...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//|0	0	1	dz|	| z |	=| z+dz |
		//|0	0	0	1 |	| 1 |	 |  1   |
		//Above is the translation matrix
		//it is a 4x4 matrix that when multiplied with a vector, translates it based on values in it's last column. 
		//in OpenGL, you cna either construct your own matrix or use the glm method translate().
